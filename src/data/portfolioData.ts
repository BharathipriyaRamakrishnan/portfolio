...
export const projects = [
  ...
  {
    id: 2,
    title: "Arise - Level Up Platform",
    description: "Arise is a gamified life-tracker that transforms your daily habits, goals, and deadlines into an immersive real-world RPG experience. Complete quests to level up your character's stats, maintain streaks to unlock unique class abilities, and battle epic bosses to forge your own legend.",
    tags: ["React.js", "Node.js", "MongoDB", "JWT"],
    github: "https://github.com/BharathipriyaRamakrishnan/arise",
    live: "https://ariselevelup.vercel.app",
    featured: true,
    color: "#9ccfd8",
  },
  {
